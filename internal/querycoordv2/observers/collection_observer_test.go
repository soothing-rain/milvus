...
func (suite *CollectionObserverSuite) TestObserveRefresh() {
	...
	suite.expectRefreshCollection(99999, false, commonpb.ErrorCode_UnexpectedError)
...
func (suite *CollectionObserverSuite) expectRefreshCollection(collID int64, expectedRefreshed bool, expectedErrorCode commonpb.ErrorCode) {
	refreshed, status := suite.ob.RefreshCollectionLoadStatus(collID)
...
func (suite *CollectionObserverSuite) expectRefreshPartition(collID int64, partIDs []int64, expectedRefreshed bool, expectedErrorCode commonpb.ErrorCode) {
	refreshed, status := suite.ob.RefreshPartitionsLoadStatus(collID, partIDs)
	log.Info("refresh result", zap.Int64("collection", collID),
