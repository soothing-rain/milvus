...
func Test_BinlogAdapterDecodeDeltalog(t *testing.T) {
...
func Test_BinlogAdapterReadInsertlog(t *testing.T) {
	...
	// failed to dispath varchar data
	...
	// failed to dispath binvector data
	...
	// failed to dispath floatvector data
