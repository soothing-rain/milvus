...
func Test_BinlogFileBool(t *testing.T) {
	...
	buf := createBinlogBuf(t, schemapb.DataType_Bool, source)
...
func Test_BinlogFileInt8(t *testing.T) {
	source := []int8{2, 4, 6, 8}
	buf := createBinlogBuf(t, schemapb.DataType_Int8, source)
...
func Test_BinlogFileInt16(t *testing.T) {
	...
	buf := createBinlogBuf(t, schemapb.DataType_Int16, source)
...
func Test_BinlogFileInt32(t *testing.T) {
	...
	buf := createBinlogBuf(t, schemapb.DataType_Int32, source)
...
func Test_BinlogFileInt64(t *testing.T) {
	...
	buf := createBinlogBuf(t, schemapb.DataType_Int64, source)
...
func Test_BinlogFileFloat(t *testing.T) {
	...
	buf := createBinlogBuf(t, schemapb.DataType_Float, source)
...
func Test_BinlogFileDouble(t *testing.T) {
	...
	buf := createBinlogBuf(t, schemapb.DataType_Double, source)
...
func Test_BinlogFileVarchar(t *testing.T) {
	...
	buf := createBinlogBuf(t, schemapb.DataType_VarChar, source)
...
func Test_BinlogFileBinaryVector(t *testing.T) {
	...
	buf := createBinlogBuf(t, schemapb.DataType_BinaryVector, vectors)
	...
	assert.NotNil(t, data)
	assert.Equal(t, vec_count*dim/8, len(data))
...
func Test_BinlogFileFloatVector(t *testing.T) {
	...
	dim := len(vectors[0])
	vec_count := len(vectors)
	buf := createBinlogBuf(t, schemapb.DataType_FloatVector, vectors)
	...
	assert.Equal(t, dim, d)
	assert.NotNil(t, data)
	assert.Equal(t, vec_count*dim, len(data))
	for i := 0; i < vec_count; i++ {
		for j := 0; j < dim; j++ {
